...
nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c5-voltage.csv 1000000 6.572917 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c5-voltage.csv 1000000 107.6354 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c5-voltage.csv 1000000 197.4896 5 >> new.out
mv performance.csv ts120rpm-c5-performance.csv
rm new.out

nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c8-supply-voltage.csv 10000 294.5538 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c8-supply-voltage.csv 10000 295.7114 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/time_series_120rpm-c8-supply-voltage.csv 10000 296.0503 5 >> new.out
mv performance.csv ts120rpm-c8-performance.csv
rm new.out

nohup bash script/float_compress.sh /home/cc/float_comp/signal/pmu_p1_L1ANG 1000000 16.054514 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/pmu_p1_L1ANG 1000000 316.050659 5 >> new.out
nohup bash script/float_compress.sh /home/cc/float_comp/signal/pmu_p1_L1ANG 1000000 359.056244 5 >> new.out
mv performance.csv pmu_p1_L1ANG-performance.csv
rm new.out

nohup bash script/float_compress.sh /home/cc/float_comp/signal/pmu_p1_L1MAG 1000000 7360.449707 5 >> new.out
